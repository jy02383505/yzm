...
<head>
	...
	<script src="/yzm/Public/js/common.js"></script>
...
<div class="panel panel-info">
	<div class="panel-heading">
		<div class="panel-title"><h4>新增图片</h4></div>
	</div>
	<div class="panel-body">
		<form action="" enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-12">
			        <div class="row">
			            <input type="file" id="filepath_tmp" class="form-control" multiple="true">
			            <input type="hidden" name="filepath" value="<?php echo ($row[filepath]); ?>">
			        </div>
			        <div class="row">
			            <div class="col-sm-12 filepath_preview"></div>
			        </div>
			    </div>
			</div>
			<div class="form-group">
...
<script>
	initUploadify('filepath_tmp', 'filepath_preview', 'filepath', 'water', 'ClickMe!', '/yzm/Public/uploadify/uploadify.swf', '<?php echo U("Allow/upload");?>', '<?php echo C("UPLOADS");?>');
</script>
