...
<!-- head -->
	...
	<div class="panel panel-info">
		<div class="panel-heading"><h4>规则列表</h4></div>
		<div class="panel-body">
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rules)): $i = 0; $__LIST__ = $rules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rule): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($rule[id]); ?></td>
						<td><?php echo ($rule[name]); ?></td>
						<td><?php echo ($rule[title]); ?></td>
						<td><?php echo ($rule[module_name]); ?></td>
						<td><a href="<?php echo U('edit');?>/id/<?php echo ($rule[id]); ?>">修改</a></td>
						<td><a href="<?php echo U('delete');?>/id/<?php echo ($rule[id]); ?>">删除</a></td>
