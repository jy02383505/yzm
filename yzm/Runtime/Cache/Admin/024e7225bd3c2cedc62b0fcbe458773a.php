...
<div class="panel panel-info">
	<div class="panel-heading">
		<div class="panel-title"><h4>新增学生信息</h4></div>
	</div>
	<div class="panel-body">
		<form action="" enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				<label>排序数字</label>
				<input type="text" name="order_num" tabindex="2" class="form-control">
			</div>
			<div class="form-group">
				<label>图片上传</label>
				<div id="imgs"></div>
			...
			<div class="form-group">
				<label>所属班级</label>
				<select name="coursePlan_id" class="form-control" tabindex="3">
					<?php if(is_array($coursePlan)): $i = 0; $__LIST__ = $coursePlan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course): $mod = ($i % 2 );++$i;?><option value="<?php echo ($course[id]); ?>"><?php echo ($course[name]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
			<div class="form-group">
				<label>录用公司</label>
				<input type="text" name="company" tabindex="4" class="form-control">
			</div>
			<div class="form-group">
				<label>职位</label>
				<input type="text" name="position" tabindex="5" class="form-control">
			</div>
			<div class="form-group">
				<label>城市</label>
				<input type="text" name="city" tabindex="6" class="form-control">
			</div>
			<div class="form-group">
