...
<div class="panel panel-info">
	<div class="panel-heading">
		<div class="panel-title"><h4>新增班次</h4></div>
	</div>
	<div class="panel-body">
		<form action="<?php echo U('add');?>" class="form" method="post">
			...
			<div class="form-group">
				<label>开班时间</label>
				<input type="text" name="curse_date" tabindex="2" id="curse_date" placeholder="请选择开班日期" class="datepicker_input">
			</div>
			<div class="form-group">
				<div>
					<label>班次状态</label>
				...
				<div class="radio-inline">
					<label>
						<input type="radio" name="status" value="1" tabindex="3"><code>盛大开班</code>
					</label>
				</div>
				<div class="radio-inline">
					<label>
						<input type="radio" name="status" value="0" tabindex="3"><code>火热报名</code>
					</label>
				</div>
			</div>
			<div class="form-group">
