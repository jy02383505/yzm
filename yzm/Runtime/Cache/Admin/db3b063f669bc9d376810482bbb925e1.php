...
<div class="panel panel-info">
	<div class="panel-heading"><h4>新增模块</h4></div>
	<div class="panel panel-body">
		<form action="" method="post">
			<div class="form-group">
				<label>模块名称</label>
				<input value="<?php echo ($row[name]); ?>" type="text" name="name" class="form-control" tabindex="1">
			</div>
			<div class="form-group">
				<label>控制器名称</label>
				<input value="<?php echo ($row[mname]); ?>" type="text" name="mname" class="form-control" tabindex="2">
			</div>

			<div class="form-group">
				<label>是否可见</label>
				<label><input <?php echo ($row[is_display]?"checked":""); ?> type="radio" name="is_display" value="1" tabindex="2"> 是</label>
				<label><input <?php echo ($row[is_display]?"":"checked"); ?> type="radio" name="is_display" value="0" tabindex="3"> 否</label>
			</div>
