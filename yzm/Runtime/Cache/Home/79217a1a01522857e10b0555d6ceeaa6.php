...
<div class="container" style="margin-top:10px;">
	<div class="row production">
		<?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="col-md-4 product" style="height:200px;">
				<a>
					<img class="img-thumbnail img-responsive img-rounded" width="100%" src="<?php echo C('UPLOADS'); echo ($row); ?>" alt="">
				</a>
