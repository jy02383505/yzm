...
<div class="container" style="margin-top:10px;">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4>
				<span class="glyphicon glyphicon-th-list"></span> 就业明星
			</h4>
			<p><?php echo C('EMPLOYMENT');?></p>
		</div>
	</div>
...
<div class="container">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4>
				<span class="glyphicon glyphicon-th-list"></span> 就业信息
			</h4>
			<p></p>
		</div>
		<div class="panel-body">
			<table class="table table-striped table-hover" style="margin-top:20px;">
				...
				<?php if(is_array($student_all)): $i = 0; $__LIST__ = $student_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$student): $mod = ($i % 2 );++$i;?><tr class="text-danger">
						<td><?php echo ($student[course_name]); ?></td>
						<td><?php echo ($student[name]); ?></td>
						<td><?php echo ($student[company]); ?></td>
						<td><?php echo ($student[city]); ?></td>
						<td><?php echo ($student[employ_date]); ?></td>
